...
privileged aspect PersonDataOnDemand_Roo_DataOnDemand {
    ...
    public Person PersonDataOnDemand.getNewTransientPerson(int index) {
        ...
        setActivatedOn(obj, index);
        setAddedOn(obj, index);
    ...
    public void PersonDataOnDemand.setActivatedOn(Person obj, int index) {
        Date activatedOn = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setActivatedOn(activatedOn);
    }
    
    public void PersonDataOnDemand.setAddedOn(Person obj, int index) {
        Date addedOn = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setAddedOn(addedOn);
    }
    
    public void PersonDataOnDemand.setAdministrator(Person obj, int index) {
    ...
    public void PersonDataOnDemand.setOpenId(Person obj, int index) {
        String openId = "openId_" + index;
